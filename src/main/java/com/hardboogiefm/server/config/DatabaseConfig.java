package com.hardboogiefm.server.config;
...
@Configuration
@EnableJpaRepositories("com.hardboogiefm.server.repository")
@EnableTransactionManagement
@PropertySource("classpath:db.properties")
@ComponentScan("com.hardboogiefm.server")
public class DatabaseConfig {
    ...
    public DataSource dataSource (){
        ...
        ds.setInitialSize(Integer.valueOf(env.getRequiredProperty("db.initalSise")));
